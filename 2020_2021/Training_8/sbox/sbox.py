...
def main(stdin: IStdin, stdout: IStdout):
    ...
    stdout.write("To get the flag you need to apply the following S-box (16x16 hex matrix) to 100 4x4 matrices\n")
    stdout.write("Send answers as 1x16 vectors\n")
    stdout.write("S-box:\n")

    for i in range(0, 256, 16):
        stdout.write(f"{inv_s_box[i]:>02x} {inv_s_box[i + 1]:>02x} {inv_s_box[i + 2]:>02x} {inv_s_box[i + 3]:>02x} "
    ...
    stdout.write("Well done! Here's your flag:" + open("src/ctf_tasks/sbox/flag.txt", 'r').read())
